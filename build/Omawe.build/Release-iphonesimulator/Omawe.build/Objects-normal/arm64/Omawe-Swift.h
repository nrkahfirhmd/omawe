...
#ifndef OMAWE_SWIFT_H
#define OMAWE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Omawe",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Omawe21LocationSearchService")
@interface LocationSearchService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class MKLocalSearchCompleter;
@interface LocationSearchService (SWIFT_EXTENSION(Omawe)) <MKLocalSearchCompleterDelegate>
