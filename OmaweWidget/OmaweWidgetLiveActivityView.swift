...
#Preview("Dynamic Island (Compact) - On the way", as: .dynamicIsland(.compact), using: OmaweWidgetAttributes(
    tripName: "Bali Road Trip",
    destinationName: "Uluwatu Temple",
    totalMates: 6
)) {
...
#Preview("Dynamic Island (Compact) - Arrived", as: .dynamicIsland(.compact), using: OmaweWidgetAttributes(
    tripName: "Bali Road Trip",
    destinationName: "Uluwatu Temple",
    totalMates: 6
)) {
